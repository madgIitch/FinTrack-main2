...
function renderAnalysis() {
    ...
    document.getElementById('kpi-revenue').textContent = `\u{20AC}${revenue.reduce((a, b)=>a + b, 0).toFixed(2)}`;
    document.getElementById('kpi-spend').textContent = `\u{20AC}${spend.reduce((a, b)=>a + b, 0).toFixed(2)}`;
