  ...
  return `
    <html>
      ...
      <body>
        ...
        <div class="footer">
          Este informe ha sido generado por <strong>FinTrack</strong> — tu compañero de confianza en el camino hacia unas finanzas más claras y tranquilas.
          <div class="small-note">Recuerda: cada euro cuenta 💡</div>
        </div>
      </body>
    </html>
  `;
