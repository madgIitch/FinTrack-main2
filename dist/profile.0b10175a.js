...
})({"hiF87":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "73bec5460b10175a";
"use strict";
...
document.addEventListener('DOMContentLoaded', ()=>{
    ...
    (0, _firebaseJs.onAuthStateChanged)((0, _firebaseJs.auth), (user)=>{
        if (user) {
            ...
            console.log("Informaci\xf3n del perfil cargada:", {
                nombre,
                apellidos,
                email
            });
            ...
            console.log("Usuario no autenticado, redirigiendo a la p\xe1gina de inicio de sesi\xf3n.");
            window.location.href = '../index.html';
        }
    });
});

},{"../js/firebase.js":"24zHi"}]},["hiF87","4EjQc"], "4EjQc", "parcelRequire94c2")

//# sourceMappingURL=profile.0b10175a.js.map
