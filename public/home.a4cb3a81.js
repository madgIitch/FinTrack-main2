...
document.addEventListener('DOMContentLoaded', ()=>{
    ...
    const getLinkedAccountsFn = async (userId)=>{
        ...
        const accountsRef = (0, _firestore.collection)(db, 'users', userId, 'linkedAccounts');
        try {
            const snapshot = await (0, _firestore.getDocs)(accountsRef);
...
},{"./firebase.js":"24zHi","firebase/firestore":"3RBs1","firebase/auth":"4ZBbi"}]},["7SMtZ","9wRWw"], "9wRWw", "parcelRequire94c2")
