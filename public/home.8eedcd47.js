...
module.bundle.HMR_BUNDLE_ID = "db1d35828eedcd47";
"use strict";
...
},{}],"h14Q4":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _messaging = require("@firebase/messaging");
parcelHelpers.exportAll(_messaging, exports);

},{"@firebase/messaging":"2nh2g","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"2nh2g":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "deleteToken", ()=>deleteToken);
parcelHelpers.export(exports, "getMessaging", ()=>getMessagingInWindow);
...
async function migrateOldDatabase(senderId) {
    ...
    const db = await (0, _idb.openDB)(OLD_DB_NAME, OLD_DB_VERSION, {
        upgrade: async (db, oldVersion, newVersion, upgradeTransaction)=>{
            var _a;
            if (oldVersion < 2) // Database too old, skip migration.
            return;
            if (!db.objectStoreNames.contains(OLD_OBJECT_STORE_NAME)) // Database did not exist. Nothing to do.
            return;
...
const ERROR_FACTORY = new (0, _util.ErrorFactory)('messaging', 'Messaging', ERROR_MAP);
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 */ async function requestGetToken(firebaseDependencies, subscriptionOptions) {
    ...
    if (!responseData.token) throw ERROR_FACTORY.create("token-subscribe-no-token" /* ErrorCode.TOKEN_SUBSCRIBE_NO_TOKEN */ );
...
async function requestUpdateToken(firebaseDependencies, tokenDetails) {
    ...
    if (!responseData.token) throw ERROR_FACTORY.create("token-update-no-token" /* ErrorCode.TOKEN_UPDATE_NO_TOKEN */ );
    return responseData.token;
}
...
async function getTokenInternal(messaging) {
    ...
    if (!tokenDetails) // No token, get a new one.
    return getNewToken(messaging.firebaseDependencies, subscriptionOptions);
        ...
        return getNewToken(messaging.firebaseDependencies, subscriptionOptions);
    } else if (Date.now() >= tokenDetails.createTime + TOKEN_EXPIRATION_MS) // Weekly token refresh
 ...
 */ async function updateSwReg(messaging, swRegistration) {
    ...
    if (!(swRegistration instanceof ServiceWorkerRegistration)) throw ERROR_FACTORY.create("invalid-sw-registration" /* ErrorCode.INVALID_SW_REGISTRATION */ );
 ...
 */ async function getToken$1(messaging, options) {
    if (!navigator) throw ERROR_FACTORY.create("only-available-in-window" /* ErrorCode.AVAILABLE_IN_WINDOW */ );
    if (Notification.permission === 'default') await Notification.requestPermission();
    if (Notification.permission !== 'granted') throw ERROR_FACTORY.create("permission-blocked" /* ErrorCode.PERMISSION_BLOCKED */ );
...
function registerMessagingInWindow() {
    (0, _app._registerComponent)(new (0, _component.Component)('messaging', WindowMessagingFactory, "PUBLIC" /* ComponentType.PUBLIC */ ));
    (0, _app._registerComponent)(new (0, _component.Component)('messaging-internal', WindowMessagingInternalFactory, "PRIVATE" /* ComponentType.PRIVATE */ ));
 ...
 */ function getMessagingInWindow(app = (0, _app.getApp)()) {
    ...
    isWindowSupported().then((isSupported)=>{
        ...
        if (!isSupported) throw ERROR_FACTORY.create("unsupported-browser" /* ErrorCode.UNSUPPORTED_BROWSER */ );
    }, (_)=>{
...
},{"@firebase/installations":"6iuP7","@firebase/component":"llS6a","idb":"7zZ8e","@firebase/util":"5D2HR","@firebase/app":"hLmie","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"6iuP7":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@firebase/app":"hLmie","@firebase/component":"llS6a","@firebase/util":"5D2HR","idb":"3GbtO","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"3GbtO":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./wrap-idb-value.js":"e3INs","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"e3INs":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"7zZ8e":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "unwrap", ()=>(0, _wrapIdbValueJs.u));
parcelHelpers.export(exports, "wrap", ()=>(0, _wrapIdbValueJs.w));
...
},{"./wrap-idb-value.js":"bDUfo","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"bDUfo":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "a", ()=>reverseTransformCache);
parcelHelpers.export(exports, "i", ()=>instanceOfAny);
